...
<body>
                ...
                <ul class="navbar-nav flex-grow-1 pe-3">
                    <li class="nav-item">
                        <a class="nav-link py-2 px-4" href="<?php echo CONTROLLER_PATH . "catalogue-books.php"; ?>">
                            <div class="d-flex flex-row align-items-center">
                                <img src="/UniBook/svg/light/store.svg" alt="" width="24" height="24" />
                                <span>Cataloghi</span>
                            </div>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link py-2 px-4" href="<?php echo CONTROLLER_PATH . "books-by-tag.php"; ?>">
                            <div class="d-flex flex-row align-items-center">
                                <img src="/UniBook/svg/light/tag.svg" alt="" width="24" height="24" />
                                <span>Tag</span>
                            </div>
                        </a>
                    </li>
                ...
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link py-2 px-4" id="dark-mode-switch-mobile" href="#">
                            <div class="d-flex flex-row align-items-center">
                                <img src="/UniBook/svg/light/theme.svg" alt="" width="24" height="24" />
                    ...
                    <li class="nav-item">
                        <?php if ($sessionManager->isLogged() || $sessionManager->isAdminLogged()) : ?>
                            <a class="nav-link py-2 px-4" href="<?php echo BASE_URL . "controller/logout.php"; ?>">
                                <div class="d-flex flex-row align-items-center">
                                    <img src="/UniBook/svg/light/logout.svg" alt="" width="24" height="24" />
                                    <span>Logout</span>
                                </div>
                            </a>
                        <?php else : ?>
                            <a class="nav-link py-2 px-4" href="<?php echo BASE_URL . "controller/login-form.php"  ?>">
                                <div class="d-flex flex-row align-items-center">
                                    <img src="/UniBook/svg/light/login.svg" alt="" width="24" height="24" />
                                    <span>Log in</span>
                                </div>
                            </a>
                        <?php endif; ?>
    ...
    <footer>
        ...
        <p><a href="<?php echo BASE_URL . 'controller/faq.php'; ?>">Domande Frequenti (FAQ)</a></p>
